          ...
          <div className="grid lg:grid-cols-[1fr_500px] xl:grid-cols-[1fr_540px] gap-12 xl:gap-20 items-center py-12 lg:py-0">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-4 mb-12 animate-fade-up delay-300">
                <Button variant="primary" size="lg" iconRight={<ArrowRight size={15} />} href="/onboarding">
                  Build My Portfolio
                </Button>
                <a href="#how-it-works" className="flex items-center gap-2.5 text-sm font-medium text-[#0d2b2b]/50 hover:text-[#008080] transition-colors duration-200 group">
                  <span
